...
#right h1 span:nth-child(3){
    animation-delay: 2s;
}
#right h1 span:nth-child(4){
    animation-delay: 3s;
}
#right h1 span:nth-child(5){
    animation-delay: 4s;
}
#right h1 span:nth-child(6){
    animation-delay: 5s;
}
#right h1 span:nth-child(7){
    animation-delay: 6s;
}
#right h1 span:nth-child(8){
    animation-delay: 7s;
}
#right h1 span:nth-child(9){
    animation-delay: 8s;
}
#right h1 span:nth-child(10){
    animation-delay: 9s;
}
#right h1 span:nth-child(11){
    animation-delay: 10s;
}
#right h1 span:nth-child(12){
    animation-delay: 11s;
}
#right h1 span:nth-child(13){
    animation-delay: 12s;
}
#right h1 span:nth-child(14){
    animation-delay: 13s;
}
#right h1 span:nth-child(15){
    animation-delay: 14s;
}
        #right table{
        ...
        <div id="left">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="/">Home</a></li>
                    <li><a href="user/userinfor">View public profile</a></li>
                    <li><a href="/admin/privacy">Privacy</a></li>
                    <li><a href="/admin/profile">Profile</a></li>
                    {{-- <li><a href="/user/becometoinstructor">Become an instructor</a></li> --}}
                </ul>
            </nav>
