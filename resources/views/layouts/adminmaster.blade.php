...
<head>
    ...
    <title>@yield('titleBlockmaster')</title>
    <style>
        *{ 
        ...
        <div id="left">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="/admin/post/index">View Posts</a></li>
                    <li><a href="/admin/user">View Order</a></li>
                    <li><a href="/admin/video/allVideo">View all video</a></li>
                </ul>
            </nav>
